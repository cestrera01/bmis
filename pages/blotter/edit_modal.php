          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input name="txt_edit_ccontact" class="form-control input-sm" type="number"
                    value="'.$row['ccontact'].'" />
                </div>
              </div><br>
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select name="txt_edit_pname" class="form-control input-sm select2" style="width:100%">
                    ...
                    echo '
                    <option value="'.$rowcp['id'].'">'.$rowcp['lname'].', '.$rowcp['fname'].' '.$rowcp['mname'].'
                    </option>
                    ';
                    }
                    echo '
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input name="txt_edit_pcontact" class="form-control input-sm" type="number"
                    value="'.$row['pcontact'].'" />
                </div>
              </div><br>
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input name="txt_edit_complaint" class="form-control input-sm" type="text"
                    value="'.$row['complaint'].'" />
                </div>
                <div class="col-sm-2" style="width:110px;">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input name="txt_edit_location" class="form-control input-sm" type="text"
                    value="'.$row['locationOfIncidence'].'" />
                </div>
              </div>
            </div>
          </div>
