                ...
                <div class="col-md-12">
                  <div class="col-md-offset-1 col-md-6">
                    <a href="backup.php?process=backup">
                      <button type="button" class="btn btn-success btn-lg span7"><i class="fa fa-database"></i> BACKUP
                        DATABASE</button>
                    </a>
                  </div>
                  <div class="col-md-5">
                    <a href="backup.php?process=restore">
                      <button type="button" class="btn btn-info btn-lg span7"><i class="fa fa-database"></i> RESTORE
                        DATABASE</button>
                    </a>
                  </div>
                </div>
