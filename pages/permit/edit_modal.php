          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <input name="txt_edit_busname" class="form-control input-sm" type="text"
                  value="' . $row['businessName'] . '" />
              </div>
              <div class="form-group">
                <label>Business Address : </label>
                <input name="txt_edit_busadd" class="form-control input-sm" type="text"
                  value="' . $row['businessAddress'] . '" />
              </div>
              <div class="form-group">
                <label>Type of Business:</label>
                <select name="ddl_edit_tob" class="form-control input-sm">
                  <option value="' . $row['typeOfBusiness'] . '" selected>' . $row['typeOfBusiness'] . '
                  </option>
