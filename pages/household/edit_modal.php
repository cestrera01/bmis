        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <label>Head of Family: <span style="color:gray; font-size: 10px;">(Lastname, Firstname
                    Middlename)</span></label>';
                $q = mysqli_query($con,"SELECT *,CONCAT(lname, ', ', fname, ' ', mname) as name from
                tblresident where id = '".$row['headoffamily']."' ");
              ...
              <div class="form-group">
                ...
                <input readonly id="txt_edit_totalmembers" name="txt_edit_totalmembers" class="form-control input-sm"
