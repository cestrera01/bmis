          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input onkeyup="show_head()" id="txt_householdno" name="txt_householdno" class="form-control input-sm"
              ...
              <div class="form-group">
                ...
                <select id="txt_hof" name="txt_hof" class="form-control input-sm select2" style="width:100%"
                  onchange="show_total()">
              ...
              <div class="form-group">
                ...
                <input id="txt_totalmembers" disabled name="txt_totalmembers" class="form-control input-sm" type="text"
