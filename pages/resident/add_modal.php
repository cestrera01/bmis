            ...
            <div class="container-fluid">
              <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input name="txt_householdnum" class="form-control input-sm input-size" type="number" min="1"
                    placeholder="Household #" />
                </div>
                <div class="form-group">
                  <label class="control-label">Differently-abled Person:</label>
                  <input name="txt_dperson" class="form-control input-sm input-size" type="text"
                    placeholder="Differently-abled Person" />
                </div>
                <div class="form-group">
                  <label class="control-label">Blood Type:</label>
                  <input name="txt_btype" class="form-control input-sm input-size" type="text"
                ...
                <div class="form-group">
                  ...
                  <input name="txt_length" class="form-control input-sm input-size" type="number" min="0"
                    placeholder="Length of Stay" />
                </div>
                <div class="form-group">
                  <label class="control-label">Religion:</label>
                  <input name="txt_religion" class="form-control input-sm input-size" type="text"
                    placeholder="Religion" />
                </div>
                <div class="form-group">
                  <label class="control-label">IgpitID:</label>
                  <input name="txt_igpit" class="form-control input-sm input-size" type="number" placeholder=""
                    min="1" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input name="txt_remarks" class="form-control input-sm input-size" type="text"
                    placeholder="Remarks" />
                </div>
                <div class="form-group">
                  <label class="control-label">Username:</label>
                  <input name="txt_uname" id="username" class="form-control input-sm input-size" type="text"
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input name="txt_zone" class="form-control input-sm" type="text" placeholder="Your purok" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input name="txt_rthead" class="form-control input-sm" type="text"
                ...
                <div class="form-group">
                  ...
                  <input name="txt_phno" class="form-control input-sm" type="number" max="999999999999" min="1"
                    placeholder="eg. 010000000001" />
                </div>
                <div class="form-group">
